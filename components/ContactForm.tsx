...
export default function ContactForm() {
  ...
  return (
    <motion.form
      ...
      className="max-w-2xl mx-auto bg-white rounded-3xl p-8 shadow-xl border-2 border-purple-200"
    >
      <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-center text-charcoal">Let's Transform Your eCommerce</h2>
        ...
        {isError && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-red-700">Please try again or email me directly at contact@example.com</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
